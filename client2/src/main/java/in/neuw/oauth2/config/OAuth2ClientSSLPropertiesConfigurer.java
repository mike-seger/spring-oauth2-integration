...
import in.neuw.oauth2.util.security.SSLContextService;
...
public class OAuth2ClientSSLPropertiesConfigurer {
    ...
    OAuth2ClientSSLPropertiesConfigurer(SSLContextService sslContextService) {
    ...
    private SslContext sslContext(final String registrationKey, final SslConfiguration sslConfiguration) throws AppBootTimeException {
        ...
        KeyManagerFactory keyManagerFactory = sslContextService.getKeyStore(sslConfiguration.keystore, sslConfiguration.keystorePassword);
        keyManagerFactories.put(registrationKey, keyManagerFactory);

        TrustManagerFactory trustManagerFactory = sslContextService.getTrustStore(sslConfiguration.truststore, sslConfiguration.truststorePassword);
